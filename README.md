...
## Project Overview
This project implements an automated control system for a high-security airport emergency door using the **Beckhoff TwinCAT 3** environment. The system integrates industrial PLC logic with an external Raspberry Pi (RPi) for biometric facial detection and communication monitoring.
